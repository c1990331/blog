$(document).ready(function() {
	...
	$("a.dropdown_button").on("click", function(){
		...
		return this.each(function(){
			...
			if(b.click){
				...
				a("#"+d).slideDown(function(){
					setTimeout(function(){a("#"+d).slideUp(function(){
						a("#"+d).remove()
						})
						},b.time)});
				a(".click_close").on("click",function(){
					a(this).slideUp(function(){a(this).remove()})})})}})(jQuery);
